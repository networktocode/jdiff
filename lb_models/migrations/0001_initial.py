    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "sslcertkey",
                    models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to="lb_models.sslcertkey"),
                ),
                (
                    "device",
                    models.ForeignKey(
            ...
            fields=[
                ...
                (
                    ...
                    nautobot.core.fields.AutoSlugField(
                        blank=True, max_length=100, populate_from="customerappprofile_id", unique=True
                    ),
                ),
                ("customerappprofile_id", models.CharField(max_length=50)),
                ("name", models.CharField(max_length=50)),
