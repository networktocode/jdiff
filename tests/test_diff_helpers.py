...
from netcompare.utils.diff_helpers import (
    dict_merger,
    group_value,
...
def test_fix_deepdiff_key_names():
    ...
    object = {"root[0]['10.1.0.0']['is_enabled']": {'new_value': False, 'old_value': True}}
    assert fix_deepdiff_key_names(object) == {'10.1.0.0': {'is_enabled': {'new_value': False, 'old_value': True}}}
...
def test_get_diff_iterables_items():
    ...
    diff_result = {
        'values_changed': {
            ...
            'iterable_item_added': {"root['Ethernet3'][1]": {'hostname': 'ios-xrv-unittest', 'port': 'Gi0/0/0/0'}, 
            }
        }
